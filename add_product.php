  ...
  <div class="col-md-8">
      <div class="panel panel-default">
        <div class="panel-heading">
          <strong>
            <span><img src="libs/images/st.png" width="30">&nbsp;</span>
          ...
          <form method="post" action="add_product.php" class="clearfix">
              <div class="form-group">
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="product-title" placeholder="Item Name / Product Title">
               </div>
              </div>
              <div class="form-group">
                <div class="row">
                 ...
                 <div class="col-md-4">
                  ...
                  <div class="col-md-4">
                    <div class="input-group">
                      ...
                      <input type="number" class="form-control" name="saleing-price" placeholder="Sell Price">
                      <span class="input-group-addon">.00</span>
                   </div>
                  </div>
               </div>
